                    ...
                    <form action="{{ route('clients.update') }}" method="POST" enctype="multipart/form-data">
                        <div class="container">
                            <div class="row">
                                ...
                                <input required name="design_name" type="hidden" value="none" class="form-control"
                                ...
                                {{-- <div class="form-group col-sm-12">
                                    ...
                                    <textarea hidden name="massage" id="massage" class="form-control" placeholder="message">{{ $data->massage }}</textarea>
