        ...
        <div class="container-fluid px-0">
            <div class="d-flex justify-content-between w-100" id="navbarSupportedContent">
                <div class="d-flex align-items-center"><button id="sidebar-toggle"
                        class="sidebar-toggle me-3 btn btn-icon-only d-lg-inline-block align-items-center justify-content-center"><svg
                ...
                <ul class="navbar-nav align-items-center">
                    ...
                    <li class="nav-item dropdown ms-lg-3"><a class="nav-link dropdown-toggle pt-1 px-0" href="#"
                        ...
                        <div class="dropdown-menu dashboard-dropdown dropdown-menu-end mt-2 py-1">
                            <a class="dropdown-item d-flex align-items-center" href="{{ route('slider') }}"> <i
                                    class="far fa-sliders-h"></i>&nbsp; Slider </a>

                            <a class="dropdown-item d-flex align-items-center" href="{{ route('products.product') }}"> <i
