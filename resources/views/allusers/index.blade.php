                    ...
                    <tbody>
                        @foreach ($data as $allusers)
                            <tr>
                                ...
                                <td><img width="100" src="{{ asset('upload/allusers/' . $allusers->images) }}">
                                </td>
                                ...
                                <td><a href="{{ route('allusers.edit', $allusers->id) }}" class="btn btn-warning btn-sm"><i
